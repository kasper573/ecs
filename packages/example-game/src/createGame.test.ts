import { describeSystem } from "../../ecs-text-adventure/src/describable/describeSystem";
import { performCommand } from "../../ecs-text-adventure/src/interactive/performCommand";
